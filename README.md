...
- [scholairly](https://scholairly.com) — AI-powered EdTech platform, 100+ active users
- [career-dashboard](https://github.com/moff05/career-dashboard) — AI job search command center built with Next.js and Claude · [live demo](https://career-dashboard-ten.vercel.app)
- [portfolio-tracker](https://github.com/moff05/portfolio-tracker) — self-hosted investment portfolio tracker, Electron + Claude
