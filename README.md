...
I build AI-powered tools — mostly for real estate, careers, and personal finance. Senior at the University of Miami (Business Technology, Math & CS minors), currently an Investment Intern at Goldenrod Companies building internal AI workflows on n8n + Claude.
...
| Project | What it is |
|---|---|
| [StackingPlanner](https://stackingplanner.com) | AI-assisted stacking plan generator for commercial real estate — co-founded at N&S Digital |
...
- [hackysack-cv](https://github.com/moff05/hackysack-cv) — computer vision analyzer for footbag gameplay video: YOLO pose tracking, Kalman-filtered sack tracking, touch/drop detection, live stats HUD
